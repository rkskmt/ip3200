...
::: {.callout-note}
- ほぼ平坦なのに **1日だけ大きな山**（最大52,168回、ふだんの約280倍）
- この日、何があった？
:::
...
![イングランドの国家債務の推移](imgs/visualization/Playfair_TimeSeries-2.jpg){width="55%"}
...
![スコットランドの輸出入（1780–1781）](imgs/visualization/960px-1786_Playfair_-_Exports_and_Imports_of_Scotland_to_and_from_different_parts_for_one_Year_from_Christmas_1780_to_Christmas_1781.jpg){width="55%"}
...
![トルコ帝国の領土配分](imgs/visualization/Playfair-piechart.jpg){width="30%"}
...
| 地理 + 時系列 | [earth :: 地球の風・気象](https://earth.nullschool.net/) |
...
## "Always plot your data first." {.badge-important}
...
- **冒頭の謎**（1日だけの大きな山）の正体は、[APIデータを可視化する](api-viz.qmd)で明かされる
